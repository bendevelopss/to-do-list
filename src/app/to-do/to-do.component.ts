...
export class ToDoComponent implements OnInit {
  ...
  constructor(private _todoService: TodoService, private _formBuilder: FormBuilder, public apiService: ApiService) {
  ...
  add() {
    ...
    this.apiService.addPost(data).subscribe((data) => console.log('new post', data));
  }
